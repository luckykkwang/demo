...
![image-20210203134158686](../../../57-SH83/59-人资项目第十一天/01-教学资料/完整笔记/assets/image-20210203134158686.png)
...
![image-20200802015023168](../../../57-SH83/59-人资项目第十一天/01-教学资料/完整笔记/assets/image-20200802015023168.png)
...
![image-20210203012823356](images/image-20210203012823356.png)
...
![image-20210203013704491](images/image-20210203013704491.png)

### 新建工作日历组件结构

>  工作日历的要求很简单，显示每个月的日期，可以设定日期的范围

![image-20210203123151149](images/image-20210203123151149.png)
...
<template>
  <div>
    ...
    <div class="select-box">
      <el-select size="small" style="width: 120px; margin-right: 10px">
        <!-- 年份取给定年份的, 前五年 + 后五年 -->
      </el-select>
...
export default {
  ...
  computed: {
    yearList() {
      ...
      // console.log(list)
      // return list
      return Array.from(new Array(11), (item, index) => this.currentYear + index - 5)
    }
  }
}
</script>
...
![image-20210203124942162](../../../57-SH83/59-人资项目第十一天/01-教学资料/完整笔记/assets/image-20210203124942162.png)
...
![image-20210203130051507](../../../57-SH83/59-人资项目第十一天/01-教学资料/完整笔记/assets/image-20210203130051507.png)
...
![image-20210203133820331](../../../57-SH83/59-人资项目第十一天/01-教学资料/完整笔记/assets/image-20210203133820331.png)
...
![image-20210203135829437](../../../57-SH83/59-人资项目第十一天/01-教学资料/完整笔记/assets/image-20210203135829437.png)

### 按需加载

推荐的思路：https://echarts.apache.org/examples/zh/editor.html?c=radar
...
echarts.use(
  [CanvasRenderer, RadarChart, TitleComponent]
)
export default {
  name: 'Radar',
  mounted() {
